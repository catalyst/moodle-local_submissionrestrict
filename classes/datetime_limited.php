...
/**
 * This is pretty much a copy of date_time_selector.
 *
...
class datetime_limited extends MoodleQuickForm_group {
            ...
            case 'createElement':
                if (isset($arg[2]['optional']) && $arg[2]['optional']) {
                    ...
                    if ($this->_usedcreateelement) {
                        ...
                        $caller->disabledIf($arg[0] . '[time]', $arg[0] . '[enabled]');
                    } else {
    ...
    public function toHtml() {
        ...
        $html = $this->_wrap[0];
        if ($this->_usedcreateelement) {
            $html .= \html_writer::tag('span', $renderer->toHtml(), ['class' => 'fdate_time_selector']);
        } else {
